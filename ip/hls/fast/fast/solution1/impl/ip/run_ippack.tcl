...
set Library     "hls"
set IPName      "fast_accel"
set Version     "1.0"
set DisplayName "fast_accel2"
set Revision    "2004231211"
set Description "Fast corner detection IP"
set Device      "zynq"
set AutoFamily  ""
...
set sdx_kernel_name "fast_accel"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/mnt/c/fpgaXilinx/fastPynq/ip/hls/fast/fast/solution1"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 src_rows W 0x0 "Data signal of src_rows" {{0 32 src_rows W 0 "Bit 31 to 0 Data signal of src_rows"}}} {0x18 src_cols W 0x0 "Data signal of src_cols" {{0 32 src_cols W 0 "Bit 31 to 0 Data signal of src_cols"}}} {0x20 threshold W 0x0 "Data signal of threshold" {{0 32 threshold W 0 "Bit 31 to 0 Data signal of threshold"}}} {0x28 unused W 0x0 "Data signal of unused" {{0 32 unused W 0 "Bit 31 to 0 Data signal of unused"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 8361898 II x}
